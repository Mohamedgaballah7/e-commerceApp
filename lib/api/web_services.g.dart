...
class _WebServices implements WebServices {
  ...
  Future<AddCartResponseDto> addCart(
    ProductIdRequestDto productIdRequest,
    String token,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    ...
    final _data = <String, dynamic>{};
    _data.addAll(productIdRequest.toJson());
  ...
  @override
  Future<GetCartResponseDto> deleteItemsInCart(String productId,
      String token,) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'token': token};
  ...
  @override
  Future<GetCartResponseDto> updateCountsInCart(String productId,
      String token,
